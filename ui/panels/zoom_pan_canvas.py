...
class ZoomPanCanvas(Frame):
    ...
    def __init__(self, master, controller=None):
        ...
        # RGB önbelleği — fare hareketi sırasında tekrar dönüşüm yapmamak için
    ...
    def show_image(self, img: Image.Image, file_path: str = None) -> None:
        ...
        # Piksel renk göstergesi için RGB önbelleği güncellenir
    ...
    def show_comparison(self, before: Image.Image, after: Image.Image) -> None:
        ...
        self._split_x    = 0.5
        # Karşılaştırma modunda RGB önbelleği güncellenir
    ...
    def _on_motion(self, event) -> None:
        ...
        if 0 <= ix < self._before_pil.width and 0 <= iy < self._before_pil.height:
            try:
                # Önbellekteki RGB görsel kullanılır, yoksa anlık dönüşüm yapılır
